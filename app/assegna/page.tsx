...
return ( <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8"> <div className="mb-6 sm:mb-8"> <div className="mb-1.5 text-sm font-medium text-gray-500 sm:mb-2">
{auctionName || "Asta"} </div>
  ...
  <div className="grid gap-5 lg:grid-cols-[1fr_360px] lg:gap-6">
    ...
    <section className="min-w-0 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
      ...
      <div className="mb-3 text-sm text-gray-500 sm:mb-4">
      ...
      {loading ? (
        ...
        <div className="max-h-[55vh] overflow-y-auto overscroll-contain pr-1 sm:max-h-[650px]">
            ...
            {filteredPlayers.map((player) => {
              ...
              return (
                <button
                  ...
                  className={`flex min-w-0 items-center justify-between gap-3 rounded-lg border p-3 text-left transition ${
                    selected
    ...
    <section className="h-fit min-w-0 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
      <h2 className="mb-4 text-lg font-bold text-gray-900 sm:mb-5">
        Assegna giocatore
      </h2>

      {selectedPlayer ? (
        <div className="mb-5 rounded-lg bg-gray-50 p-4 sm:mb-6">
        ...
        <div className="mb-5 rounded-lg border border-dashed border-gray-300 px-4 py-8 text-center text-sm text-gray-500 sm:mb-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-base outline-none focus:border-gray-500 sm:py-2.5 sm:text-sm"
          >
        ...
        <button
          ...
          className="w-full rounded-lg bg-gray-900 px-4 py-3.5 text-sm font-bold text-white transition hover:bg-gray-800 disabled:cursor-not-allowed disabled:bg-gray-300 sm:py-3"
        >
